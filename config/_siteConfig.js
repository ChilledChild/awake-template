...
export default {
  ...
  featureImage: '/uploads/aniket-deole-m6xc789hle8-unsplash.jpg',
  ...
  disqus: {
    ...
    siteShortName: '' // 'blog-danielkelly-io' change this out for my own later
  },
  ...
  newsletter: {
    ...
    mailchimp: {
      on: false,
      formAction:
        '' // change this out for my own later
    },
    custom: {
      on: false,
      formAction: ''
